                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" novalidate>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Sayfa Açıklaması
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="page_content" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="telegram" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
